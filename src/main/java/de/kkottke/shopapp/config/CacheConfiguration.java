package de.kkottke.shopapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(de.kkottke.shopapp.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(de.kkottke.shopapp.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
